...
"""
DATA_INGESTION_COLLECTION_NAME: str = "Vechile"
...
MODEL_TRAINER_MIN_SAMPLES_SPLIT: int = 22
MODEL_TRAINER_MIN_SAMPLES_LEAF: int = 18
MODEL_TRAINER_MAX_DEPTH: int = 17
MODEL_TRAINER_LEARNING_RATE:float=0.1
MODEL_TRAINER_SUBSAMPLE: int=0.8
