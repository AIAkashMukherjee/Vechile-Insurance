...
class DataTransformation:
    ...
    def initate_data_transformation(self)->DataTransformationArtifact:
        try:
            ...
            train_df = self.read_data(file_path=self.ingestion_artifact.trained_file_path)
            test_df = self.read_data(file_path=self.ingestion_artifact.test_file_path)
            ...
            input_feature_train_final, target_feature_train_final = sm.fit_resample(
                input_feature_train_arr, target_feature_train_df
            )
            input_feature_test_final, target_feature_test_final = sm.fit_resample(
            ...
            save_object(self.transformation_config.transformed_object_file_path, preprocessor)
            save_numpy_array_data(self.transformation_config.transformed_train_file_path, array=train_arr)
            save_numpy_array_data(self.transformation_config.transformed_test_file_path, array=test_arr)
