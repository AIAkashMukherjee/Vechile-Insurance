...
from src.entity.s3_estimator import VechileEstimator
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[VechileEstimator]:
        """
        ...
        try:
            ...
            vechile_estimator = VechileEstimator(bucket_name=bucket_name,
                                               model_path=model_path)

            if vechile_estimator.is_model_present(model_path=model_path):
                return vechile_estimator
            return None
        except Exception as e:
            raise  CustomException(e,sys)
